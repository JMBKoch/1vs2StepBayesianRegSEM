...
```{r, cache = T}
# load results
resultsRHSP <- read.csv("../../../output/resultsRHSP.csv", 
                        sep = " ", 
                        header = TRUE)
convRHSP <- read.csv("../../../output/convRHSP.csv",
                     sep = " ",
                     header = TRUE)
```
...
```{r}
readr::write_rds(meanPropDIVlarger5, file = "../../../Rmd/figures/meanPropDIVlarger5.Rds")
```
...
```{r}
readr::write_rds(rowsRemovedLarger5Perc, file = "../../../Rmd/figures/rowsRemovedLarger5Perc.Rds")
```
...
saveRDS(resultsRHSPFiltered, file = "../../../output/resultsRHSPFilter.Rds")
```
