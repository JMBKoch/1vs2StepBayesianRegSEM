...
```{r}
levels(PowerLong_hyper$criterion) <- c("50% Credible Interval", "80% Credible Interval", "90% Credible Interval",  "95% Credible Interval", "Treshold 0.15", "Treshold 0.10", "Treshold 0.05", "Treshold 0")
```
...
```
```{r}
levels(TypeILong_hyper$criterion) <- c("50% Credible Interval", "80% Credible Interval", "90% Credible Interval",  "95% Credible Interval", "Treshold 0.15", "Treshold 0.10", "Treshold 0.05", "Treshold 0")
```
...
Power_100+
  labs(title = "Power SVNP",
       x = NULL)  
readr::write_rds(TypeISVNP_hyper_100, file = "~/1vs2StepBayesianRegSEM/Rmd/figures/TypeISVNP_hyper.Rds")
readr::write_rds(PowerSVNP_hyper_100, file = "~/1vs2StepBayesianRegSEM/Rmd/figures/PowerSVNP_hyper.Rds")
```
