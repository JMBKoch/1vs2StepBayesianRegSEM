...
```{r}
# load results
resultsSVNP <- read_rds("~/1vs2StepBayesianRegSEM/output_unrevised/resultsSVNP.RDS")
convSVNP <- read_rds(file = "~/1vs2StepBayesianRegSEM/output_unrevised/convSVNP.RDS")
```
