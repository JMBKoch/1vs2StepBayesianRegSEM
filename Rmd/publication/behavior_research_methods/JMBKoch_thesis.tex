...
\caption{\label{fig:unnamed-chunk-6}Mean Power and Type-I-Error Rates in Selecting non-zero Crossloadings (N = 100). All hyper-parameters of the RHSP are set to 1 in the results presented here. The red dashed horizontal lines represents a power level of 0.80.}
\end{figure}
...
## conversion failure on 'Distribution of σ² in SVNP: σ ~ Cauchy(0 , 1) across
## population conditions' in 'mbcsToSbcs': dot substituted for <cf>
\end{verbatim}

\begin{verbatim}
## Warning in grid.Call(C_textBounds, as.graphicsAnnot(x$label), x$x, x$y, :
## conversion failure on 'Distribution of σ² in SVNP: σ ~ Cauchy(0 , 1) across
## population conditions' in 'mbcsToSbcs': dot substituted for <83>
\end{verbatim}
...
\begin{verbatim}
## Warning in grid.Call(C_textBounds, as.graphicsAnnot(x$label), x$x, x$y, :
## conversion failure on ' σ² (mean estimate)' in 'mbcsToSbcs': dot substituted
## for <cf>
\end{verbatim}
...
\includegraphics{JMBKoch_thesis_files/figure-latex/unnamed-chunk-25-1.pdf}
