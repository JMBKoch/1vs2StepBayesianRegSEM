...
Bayesian regularized SEM is lacking (see \textbf{van2023bayesian?} for an
...
(MIMIC) model (see also \textbf{yamaguchi2023fully?} for work on the Horseshoe
...
illustrated exist (\textbf{van2023bayesian?}; \textbf{jacobucci2018comparison?}). However,
...
such as \texttt{lslx} (\textbf{lslxpackage?}) or \texttt{regsem}
(\textbf{li2021tutorial?}) have implemented classical penalties in various SEMs.
...
We included a configuration of the SVNP where a half-Cauchy prior centered around 0 and with a scale of 1 was set as hyperprior for the standard-deviation \(\sigma\) (not the variance \(\sigma^2\))\footnote{Note that a hyper-prior was set for \(\sigma\) and not \(\sigma^2\) as this is the way to specify a normal distribution Stan. We chose to refer to \(\sigma^2\) in the general introduction of this shrinkage prior as it aligns more closely with the classical introduction of this approach by B. Muthén and Asparouhov (2012).}. We deemed this relatively simple specification to be suitable for assessing the benefits of a hyperprior over a fixed variance, given the simple nature of the model studied.
...
\hypertarget{svnp-with-hyperprior}{%
\subsubsection{SVNP with hyperprior}\label{svnp-with-hyperprior}}
...
\hypertarget{appendix-b-figures-and-tables-on}{%
\subsection{Appendix B: Figures and tables on}\label{appendix-b-figures-and-tables-on}}

\[\sigma^2\]

\begin{verbatim}
## # A tibble: 790 x 225
## # Groups:   N, Cross Loading, iteration [790]
##    mainEstMean_1 mainEstMean_2 mainEstMean_3 mainEstMean_4 mainEstMean_5
##            <dbl>         <dbl>         <dbl>         <dbl>         <dbl>
##  1         0.769         0.720         0.850         0.841         0.797
##  2         0.702         0.685         0.747         0.890         0.619
##  3         0.807         0.778         0.887         0.856         0.985
##  4         0.745         0.637         0.802         0.891         0.649
##  5         0.658         0.582         0.757         0.818         0.617
##  6         0.653         0.661         0.855         0.673         0.688
##  7         0.857         0.834         0.947         0.733         1.00 
##  8         0.893         0.788         0.757         0.831         0.726
##  9         0.917         0.995         0.894         0.755         0.893
## 10         0.822         0.680         0.874         0.760         0.567
## # i 780 more rows
## # i 220 more variables: mainEstMean_6 <dbl>, mainEstMed_1 <dbl>,
## #   mainEstMed_2 <dbl>, mainEstMed_3 <dbl>, mainEstMed_4 <dbl>,
## #   mainEstMed_5 <dbl>, mainEstMed_6 <dbl>, mainEstVar_1 <dbl>,
## #   mainEstVar_2 <dbl>, mainEstVar_3 <dbl>, mainEstVar_4 <dbl>,
## #   mainEstVar_5 <dbl>, mainEstVar_6 <dbl>, biasMainMean_1 <dbl>,
## #   biasMainMean_2 <dbl>, biasMainMean_3 <dbl>, biasMainMean_4 <dbl>, ...
\end{verbatim}
...
\includegraphics{JMBKoch_thesis_files/figure-latex/unnamed-chunk-24-1.pdf}
