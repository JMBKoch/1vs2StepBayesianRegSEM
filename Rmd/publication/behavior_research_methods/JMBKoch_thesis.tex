...
As a Bayesian solution to this issue B. Muthén and Asparouhov (2012) proposed
...
(B. Muthén \& Asparouhov, 2012). The model is then re-estimated, where cross
...
As solution to this issue, B. Muthén and Asparouhov (2012), proposed a Bayesian
...
(B. Muthén \& Asparouhov, 2012). First, the model is estimated with the
...
0.01 and 0.1, based on B. Muthén and Asparouhov (2012). For the SVNP this left us
...
We included a configuration of the SVNP where a half-Cauchy prior centered around 0 and with a scale of 1 was set as hyper-prior for the standard-deviation \(\sigma\) (not the variance \(\sigma^2\))\footnote{Note that a hyper-prior was set for \(\sigma\) and not \(\sigma^2\) as this is the way to specify a normal distribution Stan. We chose to refer to \(\sigma^2\) in the general introduction of this shrinkage prior as it aligns more closely with the classical introduction of this approach by B. Muthén and Asparouhov (2012).}. We deemed this relatively simple specification to be suitable for assessing the benefits of a hyper-prior over a fixed variance, given the simple nature of the model studied.
...
indicates the minimum power of .80 recommended by B. Muthén and Asparouhov (2012).
...
B. Muthén and Asparouhov (2012). The desired power was exclusively reached in
...
to the Bayesian CFA approach by B. Muthén and Asparouhov (2012) was made, where
...
(B. Muthén \& Asparouhov, 2012). However, the fact that the SVNP performed so
...
(B. Muthén \& Asparouhov, 2012). An important next step is thus to assess the
