...
We included a configuration of the SVNP where a Cauchy-prior with a .. of 0 and a .. of .. as hyperprior for the standard-deviation $\sigma$ (not the variance $\sigma^2$): . This corresponds to a t-prior with .. .. . Given the simple nature of the model and the parameters to shrink, we chose to only include one hyper-parameter configuration of this prior in the study. 
...
of results do not differ significantly for the MSE[^5].
...
did not differ between different hyperparameter configurations[^6]. The
...
[^6]: See <https://github.com/JMBKoch/1vs2StepBayesianRegSEM/tree/main/Rmd/analyses/RHSP> for the results of the RHSP with different hyperparameter settings.
...
one, and we focus on the results for N = 100[^7]. In the plots summarizing the Power the horizontal red dashed line
...
[^7]: The results for N = 200 of the RSHP, and for the other hyperparmatersettings, can be found on <https://github.com/JMBKoch/1vs2StepBayesianRegSEM/tree/main/Rmd/analyses/RHSP>. The results for the SVNP with n = 100 can be found on <https://github.com/JMBKoch/1vs2StepBayesianRegSEM/tree/main/Rmd/analyses/SVNP>. 
