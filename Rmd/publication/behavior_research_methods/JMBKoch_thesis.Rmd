...
SEM]. A notable exception is the work by @zhang2023bayesian who
...
$s_{slab}^2$ [@piironen_sparsity_2017]. @zhang2023bayesian showed that
...
@zhang2023bayesian found the RHSP to perform well in selecting
...
SEM models. For instance, extending the work by @zhang2023bayesian who
...
@van2023bayesian emphasizes the need for user-friendly software for
