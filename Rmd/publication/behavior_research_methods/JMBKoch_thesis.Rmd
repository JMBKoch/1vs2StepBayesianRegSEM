...
Bayesian regularized SEM is lacking [see @van2023bayesian for an
...
illustrated exist [@van2023bayesian; @jacobucci2018comparison]. However,
...
such as `lslx`  [@lslxpackage] or `regsem` 
